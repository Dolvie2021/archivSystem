...
public class MetadataForUser {
	...
	public MetadataForUser(String titel,String erstellt_am,String erstellt_von,
			int dateiGroesse, String version, int id) {
		this.setTitle(titel);
	...
	public MetadataForUser(String titel,String erstellt_am,String erstellt_von,
			int dateiGroesse, String version) {
		this.setTitle(titel);
		this.setErstellt_am(erstellt_am);
		this.setErstellt_von(erstellt_von);
		this.setDateiGroesse(dateiGroesse);
	...
	public MetadataForUser(String titel,String erstellt_am,String erstellt_von,
			int dateiGroesse, String version,File datei,int id) {
		this.setTitle(titel);
		this.setErstellt_am(erstellt_am);
		this.setErstellt_von(erstellt_von);
		this.setDateiGroesse(dateiGroesse);
 ...
 * @param dateiGröße
 */
	public void setDateiGroesse(int dateiGroesse) {
